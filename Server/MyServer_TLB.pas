...
const
  ...
  LIBID_MyServer: TGUID = '{0CDA4A0E-BDFC-48FB-BB29-63981CF5ED20}';

  IID_IMyServer: TGUID = '{7FBD8308-DE3B-4E8B-B2D0-91701208D197}';
  CLASS_MyServer_: TGUID = '{59A5A4B3-A183-42D7-B936-882C8D8216A1}';
type
...
// *********************************************************************//
  IMyServer = interface(IAppServer)
    ...
    procedure smAddTicket(ID_RIC: Integer; DATA: TDateTime; CARRIAGE: Integer; SPOT: Integer; 
                          ...
                          ID_TRIP: Integer; const DEPARTURES: WideString); safecall;
    ...
    procedure smDeleteTrip(ID: Integer; ID_ROUTE: Integer); safecall;
  end;
...
// *********************************************************************//
  IMyServerDisp = dispinterface
    ...
    procedure smAddTeam(ID: Integer; const NAME: WideString); dispid 319;
    ...
    procedure smAddTicket(ID_RIC: Integer; DATA: TDateTime; CARRIAGE: Integer; SPOT: Integer; 
                          ID_PASS: Integer; STATUS: Integer; PRICE: Integer; ID_ROUTE: Integer; 
                          ID_TRIP: Integer; const DEPARTURES: WideString); dispid 323;
...
// *********************************************************************//
// The Class CoMyServer_ provides a Create and CreateRemote method to          
// create instances of the default interface IMyServer exposed by              
// the CoClass MyServer_. The functions are intended to be used by             
...
class function CoMyServer_.Create: IMyServer;
begin
  Result := CreateComObject(CLASS_MyServer_) as IMyServer;
end;

class function CoMyServer_.CreateRemote(const MachineName: string): IMyServer;
begin
  Result := CreateRemoteComObject(MachineName, CLASS_MyServer_) as IMyServer;
end;
